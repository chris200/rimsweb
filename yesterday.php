...
<html lang="en">
  <head>
    ...
    <title>Thirsty Five Brewing Yesterday</title>
  ...
  <div class="container-fluid">
    <div class="row">
		<div class="col-md-12">
			<nav class="navbar navbar-default navbar-expand-lg navbar-light bg-light navbar-dark bg-dark">
  ...
  <div class="row">
    ...
    <script src="js/display_yesterday.js"></script>
